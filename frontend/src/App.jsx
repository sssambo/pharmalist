...
import EditNameCategoriesModal from "./components/EditNameCategoriesModal";
import EditNameUnitsModal from "./components/EditNameUnitsModal";
...
function App() {
	...
	const [step, setStep] = useState("list"); // list, validated, unvalidated, units, categories
